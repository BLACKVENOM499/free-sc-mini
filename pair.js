...
case 'menu': {
  ...
  try {
    ...
    const title = userCfg.botName || 'ᴀᴋɪɴᴅᴜ-ᴍᴅ ';
...
*╭─「  \`🤖 ${title} 🤖\`  」 ─➤*  
*│*
*│*🥷 *ᴏᴡɴᴇʀ :* ${config.OWNER_NAME || 'ᴍʀ ᴀᴋɪɴᴅᴜ'}
*│*✒️ *ᴘʀᴇғɪx :* ${config.PREFIX}
*│*🧬 *ᴠᴇʀsɪᴏɴ :*  ${config.BOT_VERSION || 'ʟᴀᴛᴇsᴛ'}
*│*🎈 *ᴘʟᴀᴛғᴏʀᴍ :* ${process.env.PLATFORM || 'ʜᴇʀᴏᴋᴜ'}
...
`.trim();
    ...
    const buttons = [
      { buttonId: `${config.PREFIX}owner`, buttonText: { displayText: "👑 ᴏᴡɴᴇʀ ᴍᴇɴᴜ" },
       type: 1 },
      { buttonId: `${config.PREFIX}download`, buttonText: { displayText: "📥 ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}tools`, buttonText: { displayText: "🛠️ ᴛᴏᴏʟ ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}settings`, buttonText: { displayText: "⚙️ ꜱᴇᴛᴛɪɴɢꜱ ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}creative`, buttonText: { displayText: "🎨 ᴄʀᴇᴀᴛɪᴠᴇ ᴍᴇɴᴜ" }, type: 1 },
...
`.trim();
    ...
    const buttons = [
      { buttonId: `${config.PREFIX}developer`, buttonText: { displayText: "👤 ᴅᴇᴠᴇʟᴏᴘᴇʀ" }, type: 1 }
    ];
...
case 'gpt': {
  try {
    ...
    const sanitized = (number || '').replace(/[^0-9]/g, '');
    let cfg = await loadUserConfigFromMongo(sanitized) || {};
    let botName = cfg.botName || '*ᴀᴋɪɴᴅᴜ-ᴍᴅ*';
    ...
    await socket.sendMessage(sender, {
      ...
      buttons: [
        { buttonId: `${config.PREFIX}menu`, buttonText: { displayText: '📜 ᴍᴇɴᴜ' }, type: 1 },
        { buttonId: `${config.PREFIX}alive`, buttonText: { displayText: '📡 ʙᴏᴛ ɪɴꜰᴏ' }, type: 1 }
      ],
      headerType: 1
    }, { quoted: fakevcard });
...
*│*✒️ *ᴘʀᴇғɪx :* .
*│*🧬 *ᴠᴇʀsɪᴏɴ :*  ${config.BOT_VERSION || 'ʟᴀᴛᴇsᴛ'}
*│*🎈 *ᴘʟᴀᴛғᴏʀᴍ :* ${process.env.PLATFORM || 'Hᴇʀᴏᴋᴜ'}
*│*📟 *ᴜᴘᴛɪᴍᴇ :* ${hours}h ${minutes}m ${seconds}s
*╰────────➤*
`;
...
`.trim();
    ...
    const buttons = [
      { buttonId: `${config.PREFIX}owner`, buttonText: { displayText: "👑 ᴏᴡɴᴇʀ ᴍᴇɴᴜ" },
       type: 1 },
      { buttonId: `${config.PREFIX}download`, buttonText: { displayText: "📥 ᴅᴏᴡɴʟᴏᴀᴅ ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}tools`, buttonText: { displayText: "🛠️ ᴛᴏᴏʟs ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}settings`, buttonText: { displayText: "⚙️ ꜱᴇᴛᴛɪɴɢꜱ ᴍᴇɴᴜ" }, type: 1 },
      { buttonId: `${config.PREFIX}creative`, buttonText: { displayText: "🎨 ᴄʀᴇᴀᴛɪᴠᴇ ᴍᴇɴᴜ" }, type: 1 },
